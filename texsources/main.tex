...
\section*{Liitteet}
Tässä tiedostossa on liitetty kaikki lähdekooditiedostot ja raaka mittausdata tiedostona 'allfiles.zip'. Voit purkaa tämän esimerkiksi 'pdfdetach' työkalulla. Tämän lisäksi lähdekoodi on myös minun github sivullani \url{} \attachfile{sources.bib}
